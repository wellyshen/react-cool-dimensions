# Contributing to REACT COOL DIMENSIONS

When contributing to this repository, please first discuss the change you wish to make via issue, email, or any other method with the owners of this repository before making a change.

Please note we have a [code of conduct](https://github.com/wellyshen/react-cool-dimensions/blob/master/CODE_OF_CONDUCT.md), please follow it in all your interactions with the project.
...
5. Update the [README.md](https://github.com/wellyshen/react-cool-dimensions/blob/master/README.md) with details of changes to the interface.
6. Update the [demo app](https://github.com/wellyshen/react-cool-dimensions/tree/master/demo/App) if needed.
...
- `yarn dev` runs the [demo app](https://github.com/wellyshen/react-cool-dimensions/tree/master/demo/App) as your playground at `localhost:10001`. Support live reloading.
